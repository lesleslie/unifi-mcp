...
- **Use UV for Tool Execution**
  ...
  - Execute tools like pyright, ruff, and unifi-mcp through UV: `uv run pyright`
...
- **Code Quality Validation**
  ...
  - Code should pass all quality checks when run through unifi-mcp
  - The ultimate goal is to run `python -m unifi-mcp -x -t` without any errors
...
- **Test Coverage Improvement (MANDATORY)**
  ...
  - **Maintain and improve test coverage** incrementally when working on features
...
- **MCP Server Integration**
  ...
  - MCP tools: `execute_unifi-mcp`, `get_job_progress`, `get_comprehensive_status`
...
- **Quality Standards Maintenance**
  ...
  - Test all documentation updates by running `python -m unifi-mcp --comprehensive`
