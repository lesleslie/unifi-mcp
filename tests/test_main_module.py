...
class TestUniFiMCPServer:
    ...
    def test_init(self):
        ...
        with patch('unifi_mcp.__main__.create_server') as mock_create_server:
            ...
            with patch('unifi_mcp.__main__.create_runtime_components') as mock_create_runtime:
                mock_runtime = Mock()
        ...
        with patch('unifi_mcp.__main__.create_server') as mock_create_server:
            ...
            with patch('unifi_mcp.__main__.create_runtime_components') as mock_create_runtime:
                ...
                with patch('builtins.print') as mock_print:
                    ...
                    mock_print.assert_called_once_with("👋 UniFi MCP Server shutdown complete")
    ...
    async def test_health_check(self):
        ...
        with patch('unifi_mcp.__main__.create_server') as mock_create_server:
            ...
            with patch('unifi_mcp.__main__.create_runtime_components') as mock_create_runtime:
                ...
                mock_health_monitor.create_component_health.return_value = mock_component_health
                mock_health_monitor.create_health_response.return_value = mock_health_response
                mock_runtime.health_monitor = mock_health_monitor
                mock_create_runtime.return_value = mock_runtime
...
def test_main():
    ...
    with patch('unifi_mcp.__main__.MCPServerCLIFactory') as mock_cli_factory_class:
        ...
        mock_cli_factory_class.create_server_cli.return_value = mock_cli_factory_instance
