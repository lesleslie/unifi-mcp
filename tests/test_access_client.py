...
class TestAccessClient:
    ...
    async def test_unlock_door(self):
        ...
        # Verify the request was made correctly
        client._make_request.assert_called_once_with("POST", "/api/v1/doors/door123/unlock")
    ...
    async def test_set_access_schedule(self):
        ...
        # Verify the request was made correctly
        client._make_request.assert_called_once_with("PUT", "/api/v1/users/user123/schedule", schedule)
        assert result == {"result": "success"}
